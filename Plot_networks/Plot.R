...
RGG$cov_matrix = make_cov_matrix(RGG, 0.2)
OCN$cov_matrix = make_cov_matrix(OCN, 0.2)
ER$cov_matrix = make_cov_matrix(ER, 0.2)
ggsave('fig/RGG_cov_med.pdf', plot_network(RGG), width = 5, height = 5, unit = 'cm')
ggsave('fig/OCN_cov_med.pdf', plot_network(OCN), width = 5, height = 5, unit = 'cm')
ggsave('fig/ER_cov_med.pdf', plot_network(ER), width = 5, height = 5, unit = 'cm')

RGG$cov_matrix = make_cov_matrix(RGG, 0.4)
OCN$cov_matrix = make_cov_matrix(OCN, 0.4)
ER$cov_matrix = make_cov_matrix(ER, 0.4)
ggsave('fig/RGG_cov_high.pdf', plot_network(RGG), width = 5, height = 5, unit = 'cm')
ggsave('fig/OCN_cov_high.pdf', plot_network(OCN), width = 5, height = 5, unit = 'cm')
ggsave('fig/ER_cov_high.pdf', plot_network(ER), width = 5, height = 5, unit = 'cm')
